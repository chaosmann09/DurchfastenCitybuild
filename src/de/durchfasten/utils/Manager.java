...
public class Manager {
    ...
    public static void updateScoreboard(Player p) throws IllegalStateException, IllegalArgumentException, UserDoesNotExistException  {
        ...
        obj.getScore(Bukkit.getOnlinePlayers().size() + "§7/" + Bukkit.getMaxPlayers()).setScore(5);
        obj.getScore("§b ").setScore(4);
        obj.getScore("§8» §6§lKonto").setScore(3);
            obj.getScore(ChatColor.RED + "" + ChatColor.BOLD + "Money: " + ChatColor.WHITE + Economy.getMoney(p.getName())).setScore(2);
